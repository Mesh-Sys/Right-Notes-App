...
public class MainActivity extends AppCompatActivity {
    ...
    private StaggeredGridLayoutManager stdgrdlmgr = new StaggeredGridLayoutManager(3,LinearLayoutManager.VERTICAL);
...
//                grdLmgr.scrollToPosition(adapter.getItemCount() - 1);
        ...
        //stdgrdlmgr.scrollToPosition(adapter.getItemCount() - 1);
        stdgrdlmgr.setGapStrategy(StaggeredGridLayoutManager.GAP_HANDLING_NONE);
        recyclerView.setAdapter(adapter);
